...
public class DrawerItemCustomAdapter extends ArrayAdapter<ObjectDrawerItem> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView ImageView_List_Item = (ImageView) listItem.findViewById(R.id.drawer_list_Item_image);
		
		TextView textView_List_Item = (TextView) listItem.findViewById(R.id.textView_drawer_List_item_text);
		...
		ImageView_List_Item.setImageResource(folder.icon);
		textView_List_Item.setText(folder.name);
